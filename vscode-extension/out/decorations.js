...
function registerDecorations(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("GitTracker.getFileConflicts", async (filePath) => {
        try {
            const axios = require("axios");
            const response = await axios.get("http://localhost:5000/file-conflicts", {
